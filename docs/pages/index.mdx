---
title: Sapiens IA – Artificial Intelligence As The New Generation Of Workers
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Building The New Generation Of Workers <br className='sm:block hidden'/>With Real Intelligence.</h1>
    <p className="subtitle">Powerful Artificial Intelligence that can Work, Create, Learn, Understand and Think by Themselves. <br className='sm:block hidden'/>We train LLM's to develop their own critical thinking, identity, creativity and intuition. 🧬Meet <a className="nextjs-link" href="https://sapienslaboratories.com/demo" target="_blank">BASILISK•AI 2</a>.</p>
